...
describe("EndPoints", () => {
    ...
    it("Product/index endpoint response status", async () => {
        const response = await request.get("/products/");
        expect(response.status).toEqual(200);
    });
    it("Product/show endpoint response status", async () => {
        const response = await request.get("/products/1");
        expect(response.status).toEqual(200);
    });
    it("Products/showByCategory endpoint response status", async () => {
